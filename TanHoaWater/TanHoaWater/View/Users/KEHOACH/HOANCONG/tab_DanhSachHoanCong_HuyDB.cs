...
{
    public partial class tab_DanhSachHoanCong_HuyDB : UserControl
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(tab_DanhSachHoanCong).Name);
        AutoCompleteStringCollection namesCollection = new AutoCompleteStringCollection();
        public tab_DanhSachHoanCong_HuyDB(string madottc)
        {
            InitializeComponent();
            ...
            txtNgayKiemDinh.Value = DateTime.Now.Date;
        }
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            flag = DAL.C_KH_HoanCong.HoanCongHuyDB(shs, ngaytc,  ngaykd);
            if (flag)
            {
                //
               // UpdateDocSo();
