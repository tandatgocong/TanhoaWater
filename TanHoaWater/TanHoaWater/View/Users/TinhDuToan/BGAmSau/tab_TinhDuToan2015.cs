...
namespace TanHoaWater.View.Users.TinhDuToan.BGAmSau
{
    ...
    public partial class tab_TinhDuToan2015 : UserControl
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(tab_TinhDuToan).Name);
        public tab_TinhDuToan2015()
        {
            InitializeComponent();
            loadComboboxPhuiDao();
            fontSize.SelectedIndex = 3;
            this.txtSHS.Text = DAL.Idetity.IdentityAMSAU();
            ...
            try
            {
                ...
                if (view && loadcongtac)
                {
                    ...
                    for (int i = 0; i < GridCacCongTac.Rows.Count; i++)
                    {
                        ...
                        GridCacCongTac.Rows[i].Cells["donvicap"].Value = "B";
            ...
            try
            {
                ...
                if (view && loadcongtac)
                {
                    ...
                    for (int i = 0; i < GridCacCongTac.Rows.Count; i++)
                    {
                        ...
                        GridCacCongTac.Rows[i].Cells["contac_loaisd"].Value = "CM";
                        GridCacCongTac.Rows[i].Cells["donvicap"].Value = "A";
                        DANHMUCVATTU dmvt = DAL.C_DanhMucVatTu.finbyMaHieu(GridCacCongTac.Rows[i].Cells["congtac_mahieu"].Value + "");
                        if (dmvt != null && dmvt.BOVT == true)
                        {
                            DataTable dongiavt = DAL.C_DonGiaVatTu.getDonGiaBoVT(dmvt.MAHIEU);
        ...
        private void GridCacCongTac_UserAddedRow(object sender, DataGridViewRowEventArgs e)
        {
            ...
            GridCacCongTac.Rows[GridCacCongTac.CurrentRow.Index].Cells["donvicap"].Value = "A";
        ...
        public void InsertBG_KICHTHUOCPHUIDAO()
        {
            try
            {
                for (int i = 0; i < this.GridPhuiDao.Rows.Count; i++)
                {
                    ...
                    {
                        AS_BG_KICHTHUOCPHUIDAO phuidao = new AS_BG_KICHTHUOCPHUIDAO();
                        phuidao.SHS = _shs;
                        ...
                        DAL.C_KichThuocPhuiDao_AS.InsertKTPD(phuidao);
                    }
                }
            }
            catch (Exception ex)
        ...
        public void InsertCONGTACBANGGIA()
        {
            try
            {
                for (int i = 0; i < this.GridCacCongTac.Rows.Count; i++)
                {
                    ...
                    if (!"".Equals(maketcau) && !"".Equals(_shs))
                    {
                        AS_BG_CONGTACBANGIA congtacbg = new AS_BG_CONGTACBANGIA();
                        congtacbg.SHS = _shs;
                        ...
                        string donvicap = this.GridCacCongTac.Rows[i].Cells["donvicap"].Value + "";
                        congtacbg.GHICHU = donvicap;
                        ...
                        try
                        {
                            DAL.LinQConnection.ExecuteCommand_("DELETE FROM AS_BG_CONGTACBANGIA where SHS='" + congtacbg.SHS + "' AND MAHIEU='" + congtacbg.MAHIEU + "' AND LOAISN='" + congtacbg.LOAISN + "' ");
                        }
                        catch (Exception ex)
                        {
                            log.Error(ex.ToString());
                        }
                        DAL.C_CongTacBangGia_AS.InsertCongTacBG(congtacbg);
        ...
        public void InsertKHOILUONGXDCB()
        {
            try
            {
                ...
                AS_BG_KHOILUONGXDCB klxdcb = new AS_BG_KHOILUONGXDCB();
                klxdcb.SHS = _shs;
                ...
                DAL.C_CongTacBangGia_AS.TongKetChiPhi(_shs, phiC3, phiGS, phiQL);
                klxdcb.CPVATTU = DAL.C_CongTacBangGia_AS.CPVATLIEU;
                klxdcb.CPNHANCONG = DAL.C_CongTacBangGia_AS.CPNHANCONG;
                klxdcb.CPMAYTHICONG = DAL.C_CongTacBangGia_AS.CPMAYTHICONG;
                if (checkCoTinhPhiCaBa.Checked)
                {
                    klxdcb.CPCABA = DAL.C_CongTacBangGia_AS.CPCABA;
                }
                else
                {
                    klxdcb.CPCABA = 0.0;
                }
                klxdcb.THUE55 = DAL.C_CongTacBangGia_AS.THUE55;
                klxdcb.CONG3 = DAL.C_CongTacBangGia_AS.TONGTRUOCTHUE;
                klxdcb.THUEGTGT = DAL.C_CongTacBangGia_AS.VAT;
                klxdcb.TONGIATRI = DAL.C_CongTacBangGia_AS.TONG;
                ...
                else
                {
                    ...
                    klxdcb.TLMDTRUOCTHUE = DAL.C_CongTacBangGia_AS.TLMDTRUOCTHUE;
                    klxdcb.TAILAPMATDUONG = DAL.C_CongTacBangGia_AS.TAILAPMATDUONG;
                }

                klxdcb.CHIPHITRUCTIEP = DAL.C_CongTacBangGia_AS.CHIPHITRUCTIEP;
                klxdcb.CHIPHICHUNG = DAL.C_CongTacBangGia_AS.CHIPHICHUNG;
                klxdcb.CPGAN = DAL.C_CongTacBangGia_AS.CPGAN;
                klxdcb.CPNHUA = DAL.C_CongTacBangGia_AS.CPNHUA;
                klxdcb.CREATEBY = DAL.C_USERS._userName;
                klxdcb.CREATEDATE = DateTime.Now;
                DAL.C_KhoiLuongXDCB_AS.InsertKTPD(klxdcb);
            }
            catch (Exception ex)
            {
        ...
        public static DataTable TongKetChiPhi(string shs, bool _PHIC3, bool _PHIGS, bool _PHIQL)
        {
            ...
            //total = DAL.C_CongTacBangGia_AS.TONG;
            myDataRow["SHS"] = shs;
            myDataRow["A"] = DAL.C_CongTacBangGia_AS.CPVATLIEU;
            myDataRow["B"] = DAL.C_CongTacBangGia_AS.B;
            myDataRow["C"] = DAL.C_CongTacBangGia_AS.C;
            myDataRow["CPCABA"] = DAL.C_CongTacBangGia_AS.CPCABA;
            myDataRow["TOTAL"] = total;
            myDataRow["VAT"] = DAL.C_CongTacBangGia_AS.VAT;
            myDataRow["B1"] = DAL.C_CongTacBangGia_AS.CPNHANCONG;
            myDataRow["C1"] = DAL.C_CongTacBangGia_AS.CPMAYTHICONG;
            myDataRow["C2"] = DAL.C_CongTacBangGia_AS.C2;
            myDataRow["D"] = DAL.C_CongTacBangGia_AS.D;
            myDataRow["E"] = DAL.C_CongTacBangGia_AS.E;
            myDataRow["F"] = DAL.C_CongTacBangGia_AS.F;
            myDataRow["G"] = DAL.C_CongTacBangGia_AS.G;
            myDataRow["H"] = DAL.C_CongTacBangGia_AS.H;
            myDataRow["I"] = DAL.C_CongTacBangGia_AS.I;
            myDataRow["J"] = DAL.C_CongTacBangGia_AS.J;
            myDataRow["K"] = DAL.C_CongTacBangGia_AS.K;
            myDataRow["L"] = DAL.C_CongTacBangGia_AS.L;

            myDataRow["TAILAPMATDUONG"] = DAL.C_CongTacBangGia_AS.TAILAPMATDUONG;
            myDataRow["TLMDTRUOCTHUE"] = DAL.C_CongTacBangGia_AS.TLMDTRUOCTHUE;
            myDataRow["CPGAN"] = DAL.C_CongTacBangGia_AS.CPGAN;
            myDataRow["CPNHUA"] = DAL.C_CongTacBangGia_AS.CPNHUA;
            _tongketgan = DAL.C_CongTacBangGia_AS.CPGAN;
            _tongketnhua = DAL.C_CongTacBangGia_AS.CPNHUA;
        ...
        public static DataTable TongKetChiPhi_A(string shs, bool _PHIC3, bool _PHIGS, bool _PHIQL)
        {
            TanHoaDataContext db = new TanHoaDataContext();
            SqlConnection conn = new SqlConnection(db.Connection.ConnectionString);

            conn.Open();
            SqlCommand cmd = new SqlCommand("TONGKETCHIPHI_AS_A", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            _CPNHUA.Direction = ParameterDirection.Output;
            cmd.ExecuteNonQuery();
            DataTable table = new DataTable("TONGKETKINHPHI_A");
            table.Columns.Add("SHS", typeof(string));
            table.Columns.Add("A", typeof(double));
            table.Columns.Add("B", typeof(double));
            table.Columns.Add("C", typeof(double));
        ...
        public static DataTable TongKetChiPhi_B(string shs, bool _PHIC3, bool _PHIGS, bool _PHIQL)
        {
            TanHoaDataContext db = new TanHoaDataContext();
            SqlConnection conn = new SqlConnection(db.Connection.ConnectionString);

            conn.Open();
            SqlCommand cmd = new SqlCommand("TONGKETCHIPHI_AS_B", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            _CPNHUA.Direction = ParameterDirection.Output;
            cmd.ExecuteNonQuery();
            DataTable table = new DataTable("TONGKETKINHPHI_B");
            table.Columns.Add("SHS", typeof(string));
            table.Columns.Add("A", typeof(double));
            table.Columns.Add("B", typeof(double));
            table.Columns.Add("C", typeof(double));
        ...
        public void INBANGIA(string _shs)
        {
            ...
            string sql = "SELECT distinct * FROM BG_CHITIETBG_AS  WHERE SHS='" + _shs + "' ORDER BY STT ASC";

            SqlDataAdapter dond = new SqlDataAdapter(sql, db.Connection.ConnectionString);
            dond.Fill(ds, "BG_CHITIETBG");


            string user = "SELECT distinct * FROM BG_TAILAPMATDUONG_AS  WHERE SHS='" + _shs + "'";
            ...
            user = "SELECT distinct  * FROM BG_THONGTINKHACHANG_AS  WHERE SHS='" + _shs + "'";
            ct = new SqlDataAdapter(user, db.Connection.ConnectionString);
            ct.Fill(ds, "BG_THONGTINKHACHANG");

            user = "SELECT distinct * FROM BG_SUMTAILAPMATDUONG_AS  WHERE SHS='" + _shs + "'";
            ct = new SqlDataAdapter(user, db.Connection.ConnectionString);
            ...
            ds.Tables.Add(TongKetChiPhi_A(_shs, phiC3, phiGS, phiQL));
            ds.Tables.Add(TongKetChiPhi_B(_shs, phiC3, phiGS, phiQL));
            ...
            for (int i = 0; i < ds.Tables["TONGKETKINHPHI_A"].Rows.Count; i++)
			{
                for (int j = 1; j < ds.Tables["TONGKETKINHPHI_A"].Columns.Count; j++)
              {
                  table.Rows[i][j] = double.Parse(ds.Tables["TONGKETKINHPHI_A"].Rows[i][j].ToString()) + double.Parse(ds.Tables["TONGKETKINHPHI_B"].Rows[i][j].ToString());
              }
           }

            ds.Tables.Add(table);
         
            double TongThanhTien = double.Parse(ds.Tables["TONGKETKINHPHI"].Rows[0]["TOTAL"].ToString());
           

            if (!vatTuXDCBKhachHangCap.Checked) {
                try
                {
                    TongThanhTien  += double.Parse(ds.Tables["BG_SUMTAILAPMATDUONG"].Rows[0][1].ToString());
                }
                catch (Exception)          {
                }
            }
            ...
            if (vatTuXDCBKhachHangCap.Checked)
            {
                rp = new rptBangGiaTuTaiLap_AS();
            }
            else
            {
                rp = new rptBangGia_AS();
            }
        ...
        private void btTinhBangGia_Click(object sender, EventArgs e)
        {
            ...
            if (!"".Equals(_shs))
            {
                AS_KHACHHANG kh=DAL.C_KhachHangAmSau.findBySHS(_shs) ;
                if (kh == null)
                {
                    kh = new AS_KHACHHANG();
                    kh.MADOT = "";
                    kh.SHS = this.txtSHS.Text;
                    kh.DANHBO = this.txtDanhBo.Text.Replace("-", "");
                    kh.HOTEN = this.txtHoTen.Text;
                    kh.SOHO = int.Parse(this.txtSoHo.Value.ToString());
                    kh.SONHA = this.txtSoNha.Text;
                    kh.DUONG = this.txtDuong.Text;
                    kh.PHUONG = this.editPhuong.SelectedValue.ToString();
                    kh.QUAN = int.Parse(this.editQuan.SelectedValue.ToString());
                    kh.NGAYNHAN = DateTime.Now.Date;
                    DAL.C_KhachHangAmSau.InsertDonHK(kh);
                }
                else
                {
                    kh.MADOT = "";
                    ...
                    kh.QUAN = int.Parse(this.editQuan.SelectedValue.ToString());
                    kh.NGAYNHAN = DateTime.Now.Date;
                    DAL.C_KhachHangAmSau.UpdateDONKH(kh);
                }
              ...
              //  banggiadaco = true;
                try
                {
                    ...
                    if (banggiadaco == true)
                    {
                        ...
                        {
                            DAL.C_CongTacBangGia_AS.deleteData(_shs);
        ...
        private void txtDanhBo_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == 13)
            {
                ...
                if (khachhang != null)
                {
                    ...
                    editPhuong.Text = DAL.C_Phuong.finbyPhuong(q.MAQUAN, khachhang.PHUONG).TENPHUONG;
