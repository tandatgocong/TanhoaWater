...
namespace TanHoaWater.View.Tool
{
    public partial class frm_ChangePassword : Form
    {
        ...
        {
            InitializeComponent();
            this.txtUserName.Text = DAL.C_USERS._userName;
        ...
        private void btChange_Click(object sender, EventArgs e)
        {
            if (this.txtMatKhauMoi.Text.Equals(this.txtNhapLaiMKMOi.Text)) {
                ...
                if (DAL.C_USERS.ChangePass(this.txtUserName.Text.Trim(), this.txtMatKhauHienTai.Text.Trim(), this.txtMatKhauMoi.Text.Trim()) == 1)
                {
