...
{
    class C_BGDC_CongTacBangGia
    {

        private static readonly ILog log = LogManager.GetLogger(typeof(C_CongTacBangGia).Name);
        
        public static bool InsertCongTacBG(BGDC_CONGTACBANGIA dm)
        {
            try
            {
                TanHoaDataContext db = new TanHoaDataContext();
                db.BGDC_CONGTACBANGIAs.InsertOnSubmit(dm);
                db.SubmitChanges();
                return true;
            }
            catch (Exception ex)
        ...
        //public static List<BGDC_CONGTACBANGIA> getListBySHS(string shs)
        //{
        //    TanHoaDataContext db = new TanHoaDataContext();
        //    var query = from kt in db.BGDC_CONGTACBANGIAs where kt.SHS == shs select kt;
        //    return query.ToList();
        //}
