...
namespace TanHoaWater.DAL
{
    class C_DHN_ChoDanhBo
    {
        ...
        public static DataTable getListHoanCong(string dottc, int flag)
        {
            ...
            string sql = "SELECT  DHN_SODOT,donkh.SHS,REPLACE(HOTEN,N'(ĐD '+CONVERT(VARCHAR(10),SOHO)+N' Hộ)',' ') AS 'HOTEN',(ISNULL(DHN_SONHA,SONHA) +' '+ ISNULL(DHN_DIACHI,DUONG) +', P.'+TENPHUONG +', Q.'+TENQUAN) AS 'DIACHI',hosokh.COTLK,hosokh.NGAYTHICONG, hosokh.CHISO, hosokh.SOTHANTLK, hosokh.HIEUDONGHO, hosokh.HOANCONG,hosokh.DHN_SOHOPDONG,hosokh.DHN_GIABIEU,hosokh.DHN_DMGOC,hosokh.DHN_DMCAPBU,hosokh.DHN_SODANHBO,hosokh.DHN_PHIENLOTRINH,hosokh.DHN_MADMA,hosokh.DHN_HIEULUC,hosokh.DHN_MAQUANPHUONG,hosokh.DHN_HSCONGTY,hosokh.DHN_MASOTHUE,hosokh.DHN_SOHO,hosokh.DHN_SONHANKHAU,DHN_HOTEN,DHN_SONHA,DHN_DIACHI,SONHA,DUONG,DHN_NGAYKD";
